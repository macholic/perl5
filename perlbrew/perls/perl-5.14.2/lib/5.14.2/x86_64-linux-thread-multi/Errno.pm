...
"x86_64-linux-thread-multi-2.6.32-220.23.1.el6.x86_64" or
	die "Errno architecture (x86_64-linux-thread-multi-2.6.32-220.23.1.el6.x86_64) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
